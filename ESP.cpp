...
Color visuals::GetPlayerVisibleColor(C_BaseEntity* local,C_BaseEntity* pPlayer)
{
	...
	{
		if (g_Options.Visuals.esp_Visible == 0 && pPlayer->GetTeamNum() != local->GetTeamNum()) // �����������
		{
			SetColor = true;
		}
		else if (g_Options.Visuals.esp_Visible == 1 && pPlayer->GetTeamNum() == local->GetTeamNum()) // �����
		{
			SetColor = true;
		}
		else if (g_Options.Visuals.esp_Visible == 2) // ����
		{
			SetColor = true;
		}
