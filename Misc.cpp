...
void misc::OnCreateMove(CInput::CUserCmd *cmd, C_BaseEntity *local, bool& bSendPacket)
{
	...
	case 8:
	{
		...
		int value = ServerTime % 20;
		switch (value) {
		case 0: setclantag(XorStr("E.ME           A")); break;
		case 1: setclantag(XorStr(".ME           AL")); break;
		case 2: setclantag(XorStr("ME           ALS")); break;
		case 3: setclantag(XorStr("E           ALSW")); break;
		case 4: setclantag(XorStr("           ALSWA")); break;
		case 5: setclantag(XorStr("          ALSWAR")); break;
		case 6: setclantag(XorStr("         ALSWARE")); break;
		case 7: setclantag(XorStr("        ALSWARE.")); break;
		case 8: setclantag(XorStr("       ALSWARE.M")); break;
		case 9: setclantag(XorStr("      ALSWARE.ME")); break;
		case 10: setclantag(XorStr("    ALSWARE.ME")); break;
		case 11: setclantag(XorStr("   ALSWARE.ME ")); break;
		case 12: setclantag(XorStr("  ALSWARE.ME  ")); break;
		case 13: setclantag(XorStr(" ALSWARE.ME   ")); break;
		case 14: setclantag(XorStr("ALSWARE.ME    ")); break;
		case 15: setclantag(XorStr("LSWARE.ME     ")); break;
		case 16: setclantag(XorStr("SWARE.ME      ")); break;
		case 17: setclantag(XorStr("WARE.ME       ")); break;
		case 18: setclantag(XorStr("ARE.ME        ")); break;
		case 19: setclantag(XorStr("RE.ME         ")); break;
