...
void Misc()
{
	...
	case 0:
	{
		...
		ImGui::BeginChild(XorStr("2 child"), ImVec2(330, 220), true);
		{
			...
			ImGui::PushItemWidth(180);
			ImGui::Combo(XorStr("##cc"), &g_Options.Misc.syncclantag, "OFF\0\rDARK HOOK\0\rPROJECT Z\0\rRank\0\rVALVE\0\rVALVE NN\0\rDARK HOOK NA\0\rAdmin CM\0\rAlsware\0");
...
void RenderInterface() {
	...
	if (bIsGuiVisible)
		...
		if (ImGui::Begin(" ALJWRY SHU | V.2", &bIsGuiVisible, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize))
		{
